...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4 shadow-sm rounded-3 py-3 mx-auto position-absolute top-50 start-50 translate-middle">
            <h4 class="text-white text-center">WELCOME TO MILAY</h4>
            <div class="d-flex justify-content-center gap-3 py-3">
                <button class="btn btn-sm btn-dark"> Documentation</button>

                <button class="btn btn-sm btn-danger"> Documentation</button>
            </div>
